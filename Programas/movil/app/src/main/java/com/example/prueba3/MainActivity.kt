...
import Pantallas.ConsultarAlumnoScreen
...
import Pantallas.PeriodoScreenDocente
        ...
        setContent {
            Prueba3Theme {
                androidx.compose.foundation.layout.Box(
                    ...
                    NavHost(navController = navController, startDestination = "Consultar") {
                        ...
                        composable("Menu") { WelcomeScreen(navController, loginViewModel) }
                        ...
                        composable("Consultar") { ConsultarAlumnoScreen(navController) }
                        ...
                        composable("Solicitareemplazo") { SolicitarReemplazo() }
                        ...
                        composable("Periodo") { PeriodoScreenDocente(
